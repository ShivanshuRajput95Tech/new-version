    ...
    <section className="">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        ...
        <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
          {/* Starter Plan */}
          <div className="flex flex-col p-6 mx-auto max-w-lg text-center bg-white rounded-lg border border-gray-100 shadow">
            ...
            <a
              href="#"
              className="text-white hover:bg-[#1B57E9] bg-primary-600 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
            >
              Get started
            </a>
          </div>
