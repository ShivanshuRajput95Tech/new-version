...
const plans = [
  ...
  },
  {
    name: "Enterprise",
    price: 499,
    description: "Best for large scale uses and redistribution.",
    features: [
      "Individual configuration",
      "No setup or hidden fees",
      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          {plans.map((plan) => (
            <div
              key={plan.name}
              className="flex flex-col p-8 text-center bg-white text-gray-900 rounded-lg border border-gray-100 shadow"
            >
              ...
              <button className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-5 py-2.5 text-sm font-medium">
                Get started
              </button>
